...
const translations = {
  en: {
    ...
    'login.demoText': 'Demo: Try 123456789012, 234567890123, 345678901234, 456789012345, or 444452518437',
  ...
  mr: {
    ...
    'login.demoText': 'डेमो: 123456789012, 234567890123, 345678901234, 456789012345, किंवा 444452518437 वापरून पहा',
  ...
  hi: {
    ...
    'login.demoText': 'डेमो: 123456789012, 234567890123, 345678901234, 456789012345, या 444452518437 आज़माएं',
