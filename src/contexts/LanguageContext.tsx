...
const translations = {
  en: {
    ...
    'login.demoText': 'Demo: Try 123456789012, 234567890123, 345678901234, or 456789012345',
  ...
  mr: {
    ...
    'login.demoText': 'डेमो: 123456789012, 234567890123, 345678901234, किंवा 456789012345 वापरून पहा',
  ...
  hi: {
    ...
    'login.demoText': 'डेमो: 123456789012, 234567890123, 345678901234, या 456789012345 आज़माएं',
